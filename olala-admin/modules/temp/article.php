...
//
function article($act, $typeFunc, $article_id, $article_menu_id, $name, $title, $description, $keywords, $img, $img_note,$link_face, $link_tw, $link_in, $comment, $content, $is_active, $hot, $created_time, $upload_img_id, $error) {
	global $db, $tth,$cate_id;
	$category = 0;
				...
				<form action="<?=$act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="link_face" maxlength="255" value="<?=stripslashes($link_face)?>" ></td>
						</tr>
						<tr>
							<td><label>Link twitter:</label></td>
							<td><input class="form-control" type="text" name="link_tw" maxlength="255" value="<?=stripslashes($link_tw)?>" ></td>
						</tr>
						<tr>
							<td><label>Link edin:</label></td>
							<td><input class="form-control" type="text" name="link_in" maxlength="255" value="<?=stripslashes($link_in)?>" ></td>
						</tr>
						<?php } ?>
						<tr>
