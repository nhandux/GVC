...
$rows = $db->select();
$cate_id = getCategoryAr($article_menu_id);
...
if(!$OK) article("?".TTH_PATH."=article_add", "add", 0, $article_menu_id, $name, $title, $description, $keywords, $img, $img_note,$link_face,$link_tw,$link_in, $comment, $content,  $is_active, $hot, $created_time, $upload_img_id, $error);
?>